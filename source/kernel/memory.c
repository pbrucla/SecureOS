...
#define inuse(p)			(((kalloc_chunk*)((char*)(p) + chunksize(p)))->size & PREV_INUSE)
#define prev_inuse(p)		((p)->size & PREV_INUSE)
#define set_inuse(p)		(((kalloc_chunk*)((char*)(p) + chunksize(p)))->size |= PREV_INUSE)
#define clear_inuse(p)		(((kalloc_chunk*)((char*)(p) + chunksize(p)))->size &= ~PREV_INUSE)
#define set_prevsize(p)		(*(size_t*)((char*)p + chunksize(p) - sizeof(size_t)) = chunksize(p))
